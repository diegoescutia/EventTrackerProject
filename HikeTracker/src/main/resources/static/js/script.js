...
function init(){
	...
	document.newRouteForm.addRoute.addEventListener('click', function(e){
		e.preventDefault();
...
function updateRoute(route){
	...
	routeInput.setAttribute('value', route.description);
	routeInput.setAttribute('type', 'textarea');
	...
	button.addEventListener('click', function(e) {
		...
		updateRoute.description = updateForm.description.value;
